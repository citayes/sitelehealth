<div id="wrapper">
	...
	<div class="col-md-8">
		<form  method="post" action="savejadwal">
				  <div class="form-group">
					<label for="name">Day</label>
					<input type="input" name="Day" class="form-control" id="Day" placeholder="Day"/>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="input" name="End" class="form-control" id="End" placeholder="End"/>
				  </div>
